...
with tf.device('/cpu:0'):
	#the structure of the cnn:
	layer1 = add_cov_layer(x_imgs,1,[5,5,1,6],activation_function = tf.nn.relu)
	#layer2 = add_max_pool(layer1,2,[1,2,2,1])
	layer3 = add_cov_layer(layer1,3,[5,5,6,16],activation_function = tf.nn.relu)
	#layer4 = add_max_pool(layer3,4,[1,2,2,1])
	layer5 = stack2line(layer3,5)
	layer6 = add_full_layer(layer5,6,120,activation_function = tf.nn.relu)
